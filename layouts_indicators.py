...
#Pass options to the menus ---- Card1
card1_menu_year = data.df_pib['AÑO'].unique()
                ...
                dbc.Container([
                    # Board 4 Plot 1
                        html.Div([
                            dcc.Dropdown(
                                # Menu Year primer tablero
                                id="opt4-board4-menu-year",
                                #Passing possible options
                                options=opt4_card_options["opt4-board4-menu-year"],
                                #Using the first value as default
                                value=[opt4_card_options['opt4-board4-menu-year'][0]['value']],
                                placeholder="Select the year",
                                multi=True,
                            ),
